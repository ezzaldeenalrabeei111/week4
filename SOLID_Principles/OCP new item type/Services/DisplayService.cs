...
namespace LibraryManagementSystem.Services
{
    ...
    public class DisplayService
    {
        ...
        public void DisplayMainMenu()
        {
            ...
            Console.WriteLine("3. Add New DVD");
            Console.WriteLine("4. Find Item by ISBN");
            Console.WriteLine("5. Search Items by Title/Author");
            Console.WriteLine("6. Add New Member");
            Console.WriteLine("7. Find Member by ID");
            Console.WriteLine("8. Borrow Item");
            Console.WriteLine("9. Return Item");
            Console.WriteLine("10. List All Items");
            Console.WriteLine("11. List All Members");
